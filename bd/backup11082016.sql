...
CREATE TABLE `actividad` (
  ...
  `fechaModificadoActividad` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idActividad`),
  UNIQUE KEY `idActividad_UNIQUE` (`idActividad`),
  KEY `fk_actividad_usuario_idx` (`correoUsuario`),
  ...
  CONSTRAINT `fk_actividad_usuario` FOREIGN KEY (`correoUsuario`) REFERENCES `usuario` (`correoUsuario`) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE `cooperativa` (
  ...
  `fechaModificadoCooperativa` varchar(45) DEFAULT NULL,
...
INSERT INTO `usuario` VALUES ('admin@insafocoop.gob.sv','admin123','admin','admin',1,4,5,3,1,'2016-08-01 16:42:54',NULL),('lgmm_93@yahoo.es','12345','Luis','M',1,1,1,1,1,'2016-08-09 15:20:09',NULL),('user1@insafocoop.gob.sv','12345','user1','user1',2,2,4,3,1,'2016-08-08 14:42:20',NULL),('user2@insafocoop.gob.sv','12345','user2','user2',2,3,3,3,1,'2016-08-08 14:46:02',NULL);
...
-- Dump completed on 2016-08-11 15:14:12
