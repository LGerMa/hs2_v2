...
CREATE TABLE IF NOT EXISTS `insafocoop`.`cooperativa` (
  ...
  `fechaModificadoCooperativa` DATETIME NULL,
...
-- -----------------------------------------------------
-- Table `insafocoop`.`estadoSemanal`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `insafocoop`.`estadoSemanal` ;

CREATE TABLE IF NOT EXISTS `insafocoop`.`estadoSemanal` (
  `idEstadoSemanal` INT NOT NULL,
  `estadoSemanal` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idEstadoSemanal`),
  UNIQUE INDEX `idEstadoSemanal_UNIQUE` (`idEstadoSemanal` ASC))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `insafocoop`.`semanal` ;
...
CREATE TABLE IF NOT EXISTS `insafocoop`.`semanal` (
  ...
  UNIQUE INDEX `codSemanal_UNIQUE` (`codSemanal` ASC),
  INDEX `fk_semanal_usuario_idx` (`correoUsuario` ASC),
  INDEX `fk_semanal_estadoSemanal_idx` (`idEstadoSemanal` ASC),
  CONSTRAINT `fk_semanal_usuario`
    FOREIGN KEY (`correoUsuario`)
    REFERENCES `insafocoop`.`usuario` (`correoUsuario`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_semanal_estadoSemanal`
    FOREIGN KEY (`idEstadoSemanal`)
    REFERENCES `insafocoop`.`estadoSemanal` (`idEstadoSemanal`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `insafocoop`.`actividad` (
  ...
  `fechaModificadoActividad` DATETIME NULL,
  `codSemanal` VARCHAR(50) NOT NULL,
  ...
  INDEX `fk_actividad_semanal_idx` (`codSemanal` ASC),
  ...
  CONSTRAINT `fk_actividad_estadoActividad`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_actividad_semanal`
