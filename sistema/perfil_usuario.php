				...
				<div class="row">
					<div class="col-sm-10 col-md-10">
						...
						<?php echo $usuario->getCorreoUsuario()." - "; 
							if($flagAdmin){
								...
								if($flagUser){
									...
									$flagModify = 1; //admin puede modificar perfil
								}else{
									echo "<i class='fa fa-lock'></i>";
									$flagModify = 0; //admin no puede modificar perfil
								}
							}
							else{
								$flagModify = 1; //puede modificar
						...
						<?php 
								...
								echo "<h1>NO TIENES LOS PERMISOS PARA ESTAR AQUI</h1>";
							}
						?>
					</div>
				</div>
